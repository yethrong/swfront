<?php
/* Smarty version 3.1.33, created on 2019-10-06 14:12:30
  from '/usr/WebSites/front/home/template/frontseting/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d99da2e08ae47_02722939',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1e5343d37966e0f9cab91c30eb1c3d40e7c36f99' => 
    array (
      0 => '/usr/WebSites/front/home/template/frontseting/menu.tpl',
      1 => 1570363947,
      2 => 'file',
    ),
  ),
...
function content_5d99da2e08ae47_02722939 (Smarty_Internal_Template $_smarty_tpl) {
?>        <!--BEGIN BACK TO TOP-->
        	<a id="totop" href="#"><i class="fa fa-angle-up"></i></a>
        <!--END BACK TO TOP-->
        <!--BEGIN TOPBAR-->
        <div id="header-topbar-option-demo" class="page-header-topbar"  style="margin-bottom: 50px;">
            <nav id="topbar" role="navigation" style="margin-top: -50px; z-index: 2;" class="navbar navbar-default navbar-static-top" >
                <div class="navbar-header">
                    <button type="button" data-toggle="collapse" data-target=".sidebar-collapse" class="navbar-toggle"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button>
                    <a id="logo" href="<?php echo $_smarty_tpl->tpl_vars['URLS_PATH']->value;?>
" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">智慧应用云平台</span><span style="display: none" class="logo-text-icon">µ</span></a>
                </div>
                        ...
                        <li class="dropdown"><a data-hover="dropdown" href="#" class="dropdown-toggle"><i class="fa fa-envelope fa-fw"></i><span class="badge badge-orange">7</span></a>
                            <ul class="dropdown-menu dropdown-messages">
                                ...
                                <li>
                                    <div class="dropdown-slimscroll">
                                        <ul>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">Jessica Spencer</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith<span class="label label-blue pull-right">New</span></span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Doe<span class="label label-orange pull-right">10 min</span></span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                        ...
                        <li class="dropdown topbar-user">
                            <a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="<?php echo $_smarty_tpl->tpl_vars['URLS_RESOURES']->value;?>
img/avatar.jpg" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">John Doe</span>&nbsp;<span class="caret"></span>
                            </a>
                        ...
                        <li class="dropdown hidden-xs">
                            <!--BEGIN THEME SETTING-->
                            <a id="theme-setting" href="javascript:;" data-hover="dropdown" data-step="1"  data-position="left" class="dropdown-toggle"><i class="fa fa-cogs"></i></a>
                            <ul class="dropdown-menu dropdown-theme-setting"  style="width: 150px;">
		                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['URLS_PATH']->value;?>
appseting.html" ><i class="fa fa-desktop fa-fw"><div class="icon-bg bg-pink"></div></i><span style="color:#fff;">&nbsp;&nbsp;应用管理</span></a>  </li>
		                         <li><a href="<?php echo $_smarty_tpl->tpl_vars['URLS_PATH']->value;?>
frontseting.html"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;模块管理</span></a> </li>
		                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['URLS_PATH']->value;?>
groupseting.html"><i class="fa fa-rocket fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;组件管理</span></a> </li>
		                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['URLS_PATH']->value;?>
dataseting.html"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;数据管理</span></a> </li>
                            </ul>
                            <!--END THEME SETTING-->
                        </li>
                    </ul>
