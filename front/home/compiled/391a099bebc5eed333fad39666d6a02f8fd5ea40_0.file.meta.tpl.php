...
/* Smarty version 3.1.33, created on 2019-10-19 00:24:22
  from '/var/www/html/front/home/template/appseting/meta.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5da9e7364af1d3_04262490',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '391a099bebc5eed333fad39666d6a02f8fd5ea40' => 
    array (
      0 => '/var/www/html/front/home/template/appseting/meta.tpl',
      1 => 1569141627,
      2 => 'file',
    ),
  ),
...
function content_5da9e7364af1d3_04262490 (Smarty_Internal_Template $_smarty_tpl) {
?>            <!--BEGIN SIDEBAR MENU-->
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div id="form-layouts" class="sidebar-collapse menu-scroll ">
                    ...
                    <div class="clearfix"></div>
	                    <div style="background: transparent; border: 0; box-shadow: none !important;margin: 5px !important;" class="tab-content pan mtl mbn responsive">
		                    <div id="tab-form-actions" class="tab-pane fade active in">
		                     ...
		                     <div id="tab-two-columns" class="tab-pane fade ">
									<div class="portlet box portlet-wite small" controltype = "panel" >
		                                ...
		                                <div class="portlet-body" style="padding: 2px;">
			                                ...
			                                <div class="panel panel-default">
			                                    <div class="panel-heading"><a data-toggle="collapse" data-parent="#accordion1" href="#collapseOne1">表单属性</a>
		                                                <div style="float: right;margin: -3px;">
		                                                   ...
		                                                   <button type="button" class="btn btn-violet" style="padding: 1px 6px;font-size: 12px;">保存</button>&nbsp;&nbsp;<i class="indicator glyphicon glyphicon-chevron-down pull-right mts text-muted"></i>
                                        				</div>
			                                    </div>
			                                        ...
			                                        <div class="panel-body" style="padding: 4px;">
														<table id="user" class="table table-bordered table-striped" style="margin-bottom: 5px;">
					                                        <tbody>
					                                            <tr>
					                                                <td width="30%">表单名称</td>
					                                                 <td><a id="selframname" href="#" data-type="text" data-pk="1" data-title="请输入新的表单名" class="editable editable-click">表单名称</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td data-target="#modal-wide-width" data-toggle="modal">表单图标</td>
					                                                 <td><a id="selframicon"  href="#" data-type="select" data-pk="1"   class="editable editable-click" data-toggle="modal" data-target="#modal-wide-icon" >请点击更换&nbsp;&nbsp;<i class="fa fa-credit-card"></i></a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>表单类型</td>
					                                            ...
					                                            <tr>
					                                                <td>数据绑定</td>
					                                                 <td><a id="selframdata" href="#" class="editable editable-click" data-toggle="modal" data-target="#modal-sql-config"  style="pointer-events: none;">未设定数据表</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>标题颜色</td>
					                                                 <td><a id="selframcolorclick" href="#" class="editable editable-click">请点击更换</a><input id="selframcolor" type="color" value="#0a819c" style="height:10px; width:0px;border: 1px solid; visibility:hidden;" ></td>
					                                            </tr>
					                                            <tr>
					                                                <td>设置按钮</td>
					                                                <td><a id="selframbtnlist" href="#" data-type="select2" data-value="" data-title="设置按钮状态" class="editable editable-click" data-original-title="" title="">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>刷新按钮</td>
					                                                <td><a id = "selframreflash" href="#" data-type="select" data-value="" data-title="设置按钮状态" class="editable editable-click" data-original-title="" title="">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>全屏按钮</td>
					                                                <td><a id="selframfullScreen" href="#" data-type="select" data-value="" data-title="设置按钮状态" class="editable editable-click" data-original-title="" title="">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>缩小按钮</td>
					                                                <td><a id="selframmin" href="#" data-type="select" data-value="" data-title="设置按钮状态" class="editable editable-click" data-original-title="" title="">不使用</a>
					                                                </td>
					                                            </tr>
					                                            <tr>
					                                                <td>关闭按钮</td>
					                                                <td><a id="selframclose" href="#" data-type="select" data-value="" data-title="设置按钮状态" class="editable editable-click" data-original-title="" title="">不使用</a>
					                                                </td>
					                                            </tr>
					                                        </tbody>
					                                    </table>
			                                ...
			                                <div class="panel panel-default">
			                                    <div class="panel-heading">
			                                    	<a  id = 'control-attri'  getcontrol = "columns-1" data-toggle="collapse" data-parent="#accordion1" href="#collapseTwo1">控件属性</a><i class="indicator glyphicon glyphicon-chevron-left pull-right mts text-muted"></i>
			                                    </div>
			                                        ...
			                                        <div class="panel-body" style="padding: 4px;">
			                                        	<table id="user" class="table table-bordered table-striped" style="margin-bottom: 5px;">
					                                        <tbody>
					                                            <tr>
					                                                <td>设置按钮</td>
					                                                <td><a id="selframbtnlist" href="#" class="editable editable-click">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>刷新按钮</td>
					                                                <td><a id = "selframreflash" href="#" class="editable editable-click">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>全屏按钮</td>
					                                                <td><a id="selframfullScreen" href="#" class="editable editable-click">不使用</a></td>
					                                            </tr>
					                                            <tr>
					                                                <td>缩小按钮</td>
					                                                <td><a id="selframmin" href="#" class="editable editable-click">不使用</a>
					                                                </td>
					                                            </tr>
					                                            <tr>
					                                                <td>关闭按钮</td>
					                                                <td><a id="selframclose" href="#" class="editable editable-click">不使用</a>
					                                                </td>
					                                            </tr>
					                                        </tbody>
					                                    </table>
			                                ...
			                                <div class="panel panel-default">
			                                    <div class="panel-heading"><a data-toggle="collapse" data-parent="#accordion1" href="#collapseThree1">表单列表</a><i class="indicator glyphicon glyphicon-chevron-left pull-right mts text-muted"></i>
			                                    </div>
