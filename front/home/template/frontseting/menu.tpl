        ...
        <div id="header-topbar-option-demo" class="page-header-topbar"  style="margin-bottom: 50px;">
            <nav id="topbar" role="navigation" style="margin-top: -50px; z-index: 2;" class="navbar navbar-default navbar-static-top" >
                <div class="navbar-header">
                    ...
                    <a id="logo" href="<!-- {$URLS_PATH} -->" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">智慧应用云平台</span><span style="display: none" class="logo-text-icon">µ</span></a>
                </div>
                <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                    ...
                    <ul class="nav navbar navbar-top-links navbar-right mbn">
                        ...
                        <li class="dropdown"><a data-hover="dropdown" href="#" class="dropdown-toggle"><i class="fa fa-envelope fa-fw"></i><span class="badge badge-orange">7</span></a>
                            <ul class="dropdown-menu dropdown-messages">
                                ...
                                <li>
                                    <div class="dropdown-slimscroll">
                                        <ul>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">Jessica Spencer</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith<span class="label label-blue pull-right">New</span></span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Doe<span class="label label-orange pull-right">10 min</span></span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                            <li><a href="email-view-mail.html" target="_blank"><span class="avatar"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle"/></span><span class="info"><span class="name">John Smith</span><span class="desc">Lorem ipsum dolor sit amet...</span></span></a>
                                            </li>
                                        </ul>
                        ...
                        <li class="dropdown topbar-user">
                            <a data-hover="dropdown" href="#" class="dropdown-toggle"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-responsive img-circle" />&nbsp;<span class="hidden-xs">John Doe</span>&nbsp;<span class="caret"></span>
                            </a>
                        ...
                        <li class="dropdown hidden-xs">
                            ...
                            <ul class="dropdown-menu dropdown-theme-setting"  style="width: 150px;">
		                        <li><a href="<!-- {$URLS_PATH} -->appseting.html" ><i class="fa fa-desktop fa-fw"><div class="icon-bg bg-pink"></div></i><span style="color:#fff;">&nbsp;&nbsp;应用管理</span></a>  </li>
		                         <li><a href="<!-- {$URLS_PATH} -->frontseting.html"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;模块管理</span></a> </li>
		                        <li><a href="<!-- {$URLS_PATH} -->groupseting.html"><i class="fa fa-rocket fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;组件管理</span></a> </li>
		                        <li><a href="<!-- {$URLS_PATH} -->dataseting.html"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span style="color:#fff;">&nbsp;&nbsp;数据管理</span></a> </li>
                            </ul>
                            <!--END THEME SETTING-->
                        </li>
                    </ul>
