            ...
            <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
                <div class="sidebar-collapse menu-scroll">
                    <ul id="side-menu" class="nav">
                        <li class="user-panel">
                            <div class="thumb"><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" alt="" class="img-circle" />
                            </div>
                            <div class="info">
                                <p>用户名</p>
                                <ul class="list-inline list-unstyled">
                                    ...
                                    <li><a href="<!-- {$URLS_PATH} -->appseting.html" data-hover="tooltip"  title="应用模块编辑" data-target="#modal-config"><i class="fa fa-cog"></i></a>
                                    </li>
                ...
                <div id="chat-box" style="top:400px">
                    ...
                    <div class="chat-content">
                        <ul class="chat-box-body">
                            <li>
                                <p><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" class="avt" /><span class="user">John Doe</span><span class="time">09:33</span>
                                </p>
                                <p>Hi Swlabs, we have some comments for you.</p>
                            </li>
                            <li class="odd">
                                <p><img src="<!-- {$URLS_RESOURES} -->img/avatar.jpg" class="avt" /><span class="user">Swlabs</span><span class="time">09:33</span>
                                </p>
